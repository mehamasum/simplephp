 ...
 if($auth == '01521112085') {
	...
	if ($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
			echo "User: " . $row['email']. " dob: " . $row['dobirth']. " W: ".$row['weight']."<br>";
		}
	} else {
		echo "0 results<br>";
	}
